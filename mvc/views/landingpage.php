                    ...
                    <div class="right">
                        <ul class="utility-items nav">
                            <li class="nav-item">
                                    ...
                                    <a href="login.php" class="nav-link login">Đăng Nhập</a>
                            </li>
                            <li class="nav-item">
                                    <!--điều hướng đến trang đăng kí-->
                                    <a href="login.php" class="nav-link register">Đăng Kí Tài Khoản</a>
                            </li>
                        </ul>
                    </div> 
            </div>
        ...
        <div id="myCarousel" class="carousel slide border" data-ride="carousel">
          ...
          <div class="carousel-inner">
             <div class="carousel-item active">
                <img class="d-block w-100" src="../public/css/image-folder/jsss-homepage-desktop.png.imgw.1888.1888.jpeg" alt="Cat">
             </div>
                              ...
                              <div class="col-3 full-size">
                                  <div class="product-items mouse-item contain-img full-size">
                                      <a href="#" class="full-size"> 
                                        ...
                                        <img src="../public/css/image-folder/home-product-swatch-3.png.imgw.342.342.jpeg" alt="">
                                ...
                                <div class="col-3 full-size">
                                    <div class="product-items mouse-item contain-img full-size">
                                        <a href="#" class="full-size"> 
                                            ...
                                            <img src="../public/css/image-folder/home-product-swatch-2.png.imgw.342.342.jpeg" alt="">
                                  ...
                                  <div class="col-3 full-size">
                                      <div class="product-items mouse-item contain-img full-size">
                                          <a href="#" class="full-size"> 
                                              ...
                                              <img src="../public/css/image-folder/home-product-swatch-1.png.imgw.342.342.jpeg" alt="">
                                  ...
                                  <div class="col-3 full-size">
                                      <div class="product-items mouse-item contain-img full-size">
                                          <a href="#" class="full-size"> 
                                              ...
                                              <img src="../public/css/image-folder/speakers-483813_640.jpg" alt="">
                                            </a>
